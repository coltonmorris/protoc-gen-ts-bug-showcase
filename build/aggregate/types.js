...
export var orphan;
(function (orphan) {
    orphan.types = __assign({}, orphan_in, empty_message_no_service, enum_message, map_message, oneof_message, parent_message_v2, parent_message_v3, primitive_message_v2, primitive_message_v3, repeated_primitive_message, reserved_words, simple, simple_service, simplevalue, well_known_message, external_child_message, external_enum);
})(orphan || (orphan = {}));
