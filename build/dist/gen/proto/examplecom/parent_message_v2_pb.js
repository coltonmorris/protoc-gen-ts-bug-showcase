...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.examplecom.ParentMessageV2.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            internalChildrenList: jspb.Message.toObjectList(msg.getInternalChildrenList(), proto.examplecom.ParentMessageV2.InternalChildMessage.toObject, includeInstance),
            ...
            externalChildrenList: jspb.Message.toObjectList(msg.getExternalChildrenList(), proto_othercom_external_child_message_pb.ExternalChildMessage.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.examplecom.ParentMessageV2.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.examplecom.ParentMessageV2.InternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getOptInternalChildMessage();
    if (f != null) {
        writer.writeMessage(2, f, proto.examplecom.ParentMessageV2.InternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getInternalChildrenList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.examplecom.ParentMessageV2.InternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getExternalChildMessage();
    if (f != null) {
        writer.writeMessage(4, f, proto_othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getOptExternalChildMessage();
    if (f != null) {
        writer.writeMessage(5, f, proto_othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getExternalChildrenList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(6, f, proto_othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
};
/**
 * Generated by JsPbCodeGenerator.
...
proto.examplecom.ParentMessageV2.prototype.getInternalChildMessage = function () {
    return /** @type{!proto.examplecom.ParentMessageV2.InternalChildMessage} */ (jspb.Message.getWrapperField(this, proto.examplecom.ParentMessageV2.InternalChildMessage, 1, 1));
};
...
proto.examplecom.ParentMessageV2.prototype.getOptInternalChildMessage = function () {
    return /** @type{?proto.examplecom.ParentMessageV2.InternalChildMessage} */ (jspb.Message.getWrapperField(this, proto.examplecom.ParentMessageV2.InternalChildMessage, 2));
};
...
proto.examplecom.ParentMessageV2.prototype.getInternalChildrenList = function () {
    return /** @type{!Array.<!proto.examplecom.ParentMessageV2.InternalChildMessage>} */ (jspb.Message.getRepeatedWrapperField(this, proto.examplecom.ParentMessageV2.InternalChildMessage, 3));
};
...
proto.examplecom.ParentMessageV2.prototype.getExternalChildMessage = function () {
    return /** @type{!proto.othercom.ExternalChildMessage} */ (jspb.Message.getWrapperField(this, proto_othercom_external_child_message_pb.ExternalChildMessage, 4, 1));
};
...
proto.examplecom.ParentMessageV2.prototype.getOptExternalChildMessage = function () {
    return /** @type{?proto.othercom.ExternalChildMessage} */ (jspb.Message.getWrapperField(this, proto_othercom_external_child_message_pb.ExternalChildMessage, 5));
};
...
proto.examplecom.ParentMessageV2.prototype.getExternalChildrenList = function () {
    return /** @type{!Array.<!proto.othercom.ExternalChildMessage>} */ (jspb.Message.getRepeatedWrapperField(this, proto_othercom_external_child_message_pb.ExternalChildMessage, 6));
};
...
//# sourceMappingURL=parent_message_v2_pb.js.map