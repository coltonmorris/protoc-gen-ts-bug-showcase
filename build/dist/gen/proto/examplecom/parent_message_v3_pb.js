...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.examplecom.ParentMessageV3.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            internalChildrenList: jspb.Message.toObjectList(msg.getInternalChildrenList(), proto.examplecom.ParentMessageV3.InternalChildMessage.toObject, includeInstance),
...
proto.examplecom.ParentMessageV3.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.examplecom.ParentMessageV3.InternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getInternalChildrenList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.examplecom.ParentMessageV3.InternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getExternalChildMessage();
    if (f != null) {
        writer.writeMessage(3, f, proto_othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
    f = message.getExternalChildrenList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, proto_othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
};
/**
 * Generated by JsPbCodeGenerator.
...
proto.examplecom.ParentMessageV3.prototype.getInternalChildMessage = function () {
    return /** @type{?proto.examplecom.ParentMessageV3.InternalChildMessage} */ (jspb.Message.getWrapperField(this, proto.examplecom.ParentMessageV3.InternalChildMessage, 1));
};
...
proto.examplecom.ParentMessageV3.prototype.getInternalChildrenList = function () {
    return /** @type{!Array.<!proto.examplecom.ParentMessageV3.InternalChildMessage>} */ (jspb.Message.getRepeatedWrapperField(this, proto.examplecom.ParentMessageV3.InternalChildMessage, 2));
};
...
proto.examplecom.ParentMessageV3.prototype.getExternalChildMessage = function () {
    return /** @type{?proto.othercom.ExternalChildMessage} */ (jspb.Message.getWrapperField(this, proto_othercom_external_child_message_pb.ExternalChildMessage, 3));
};
...
proto.examplecom.ParentMessageV3.prototype.getExternalChildrenList = function () {
    return /** @type{!Array.<!proto.othercom.ExternalChildMessage>} */ (jspb.Message.getRepeatedWrapperField(this, proto_othercom_external_child_message_pb.ExternalChildMessage, 4));
};
...
//# sourceMappingURL=parent_message_v3_pb.js.map