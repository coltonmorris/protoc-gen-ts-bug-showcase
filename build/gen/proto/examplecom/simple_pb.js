...
proto.examplecom.MySimple.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(4, f, google_protobuf_compiler_plugin_pb.CodeGeneratorRequest.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(6, f, google_protobuf_api_pb.Method.serializeBinaryToWriter);
    }
    f = message.getSomeGeneratedCodeInfo();
    if (f != null) {
        writer.writeMessage(7, f, google_protobuf_descriptor_pb.GeneratedCodeInfo.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(9, f, google_protobuf_empty_pb.Empty.serializeBinaryToWriter);
    }
    f = message.getSomeFieldMask();
    if (f != null) {
        writer.writeMessage(10, f, google_protobuf_field_mask_pb.FieldMask.serializeBinaryToWriter);
    }
    f = message.getSomeSourceContext();
    if (f != null) {
        writer.writeMessage(11, f, google_protobuf_source_context_pb.SourceContext.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(14, f, google_protobuf_type_pb.Type.serializeBinaryToWriter);
    }
    f = message.getSomeDoubleValue();
    if (f != null) {
        writer.writeMessage(15, f, google_protobuf_wrappers_pb.DoubleValue.serializeBinaryToWriter);
    }
};
/**
...
proto.examplecom.MySimple.prototype.getSomeCodeGeneratorRequest = function () {
    return /** @type{?proto.google.protobuf.compiler.CodeGeneratorRequest} */ (jspb.Message.getWrapperField(this, google_protobuf_compiler_plugin_pb.CodeGeneratorRequest, 4));
};
...
proto.examplecom.MySimple.prototype.getSomeMethod = function () {
    return /** @type{?proto.google.protobuf.Method} */ (jspb.Message.getWrapperField(this, google_protobuf_api_pb.Method, 6));
};
...
proto.examplecom.MySimple.prototype.getSomeGeneratedCodeInfo = function () {
    return /** @type{?proto.google.protobuf.GeneratedCodeInfo} */ (jspb.Message.getWrapperField(this, google_protobuf_descriptor_pb.GeneratedCodeInfo, 7));
};
...
proto.examplecom.MySimple.prototype.getSomeDuration = function () {
    return /** @type{?proto.google.protobuf.Duration} */ (jspb.Message.getWrapperField(this, google_protobuf_duration_pb.Duration, 8));
};
...
proto.examplecom.MySimple.prototype.getSomeEmpty = function () {
    return /** @type{?proto.google.protobuf.Empty} */ (jspb.Message.getWrapperField(this, google_protobuf_empty_pb.Empty, 9));
};
...
proto.examplecom.MySimple.prototype.getSomeFieldMask = function () {
    return /** @type{?proto.google.protobuf.FieldMask} */ (jspb.Message.getWrapperField(this, google_protobuf_field_mask_pb.FieldMask, 10));
};
...
proto.examplecom.MySimple.prototype.getSomeSourceContext = function () {
    return /** @type{?proto.google.protobuf.SourceContext} */ (jspb.Message.getWrapperField(this, google_protobuf_source_context_pb.SourceContext, 11));
};
...
proto.examplecom.MySimple.prototype.getSomeType = function () {
    return /** @type{?proto.google.protobuf.Type} */ (jspb.Message.getWrapperField(this, google_protobuf_type_pb.Type, 14));
};
...
proto.examplecom.MySimple.prototype.getSomeDoubleValue = function () {
    return /** @type{?proto.google.protobuf.DoubleValue} */ (jspb.Message.getWrapperField(this, google_protobuf_wrappers_pb.DoubleValue, 15));
};
...
//# sourceMappingURL=simple_pb.js.map