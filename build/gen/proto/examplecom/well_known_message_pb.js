...
proto.examplecom.WellKnownMessage.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, google_protobuf_compiler_plugin_pb.CodeGeneratorRequest.serializeBinaryToWriter);
    }
    f = message.getMyAny();
    if (f != null) {
    ...
    if (f != null) {
        writer.writeMessage(3, f, google_protobuf_api_pb.Method.serializeBinaryToWriter);
    }
    f = message.getMyGeneratedCodeInfo();
    if (f != null) {
        writer.writeMessage(4, f, google_protobuf_descriptor_pb.GeneratedCodeInfo.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(6, f, google_protobuf_empty_pb.Empty.serializeBinaryToWriter);
    }
    f = message.getMyFieldMask();
    if (f != null) {
        writer.writeMessage(7, f, google_protobuf_field_mask_pb.FieldMask.serializeBinaryToWriter);
    }
    f = message.getMySourceContext();
    if (f != null) {
        writer.writeMessage(8, f, google_protobuf_source_context_pb.SourceContext.serializeBinaryToWriter);
    }
    ...
    f = message.getMyType();
    if (f != null) {
        writer.writeMessage(11, f, google_protobuf_type_pb.Type.serializeBinaryToWriter);
    }
    f = message.getMyDoubleValue();
    if (f != null) {
        writer.writeMessage(12, f, google_protobuf_wrappers_pb.DoubleValue.serializeBinaryToWriter);
    }
};
/**
...
proto.examplecom.WellKnownMessage.prototype.getMyCodeGeneratorRequest = function () {
    return /** @type{?proto.google.protobuf.compiler.CodeGeneratorRequest} */ (jspb.Message.getWrapperField(this, google_protobuf_compiler_plugin_pb.CodeGeneratorRequest, 1));
};
...
proto.examplecom.WellKnownMessage.prototype.getMyMethod = function () {
    return /** @type{?proto.google.protobuf.Method} */ (jspb.Message.getWrapperField(this, google_protobuf_api_pb.Method, 3));
};
...
proto.examplecom.WellKnownMessage.prototype.getMyGeneratedCodeInfo = function () {
    return /** @type{?proto.google.protobuf.GeneratedCodeInfo} */ (jspb.Message.getWrapperField(this, google_protobuf_descriptor_pb.GeneratedCodeInfo, 4));
};
...
proto.examplecom.WellKnownMessage.prototype.getMyEmpty = function () {
    return /** @type{?proto.google.protobuf.Empty} */ (jspb.Message.getWrapperField(this, google_protobuf_empty_pb.Empty, 6));
};
...
proto.examplecom.WellKnownMessage.prototype.getMyFieldMask = function () {
    return /** @type{?proto.google.protobuf.FieldMask} */ (jspb.Message.getWrapperField(this, google_protobuf_field_mask_pb.FieldMask, 7));
};
...
proto.examplecom.WellKnownMessage.prototype.getMySourceContext = function () {
    return /** @type{?proto.google.protobuf.SourceContext} */ (jspb.Message.getWrapperField(this, google_protobuf_source_context_pb.SourceContext, 8));
};
...
proto.examplecom.WellKnownMessage.prototype.getMyType = function () {
    return /** @type{?proto.google.protobuf.Type} */ (jspb.Message.getWrapperField(this, google_protobuf_type_pb.Type, 11));
};
...
proto.examplecom.WellKnownMessage.prototype.getMyDoubleValue = function () {
    return /** @type{?proto.google.protobuf.DoubleValue} */ (jspb.Message.getWrapperField(this, google_protobuf_wrappers_pb.DoubleValue, 12));
};
...
//# sourceMappingURL=well_known_message_pb.js.map