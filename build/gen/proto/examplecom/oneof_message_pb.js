...
proto.examplecom.OneOfMessage.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(2, f, proto_othercom_external_child_message_pb.ExternalChildMessage.serializeBinaryToWriter);
    }
...
proto.examplecom.OneOfMessage.prototype.getExternalChildMessage = function () {
    return /** @type{?proto.othercom.ExternalChildMessage} */ (jspb.Message.getWrapperField(this, proto_othercom_external_child_message_pb.ExternalChildMessage, 2));
};
