...
proto.examplecom.RepeatedPrimitiveMessage.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writePackedSint64(8, f);
    }
    f = message.getMyFixed32List();
    if (f.length > 0) {
        writer.writePackedFixed32(9, f);
    }
    f = message.getMyFixed64List();
    if (f.length > 0) {
        writer.writePackedFixed64(10, f);
    }
    f = message.getMySfixed32List();
    if (f.length > 0) {
        writer.writePackedSfixed32(11, f);
    }
    f = message.getMySfixed64List();
    if (f.length > 0) {
        writer.writePackedSfixed64(12, f);
    }
    f = message.getMyBoolList();
    if (f.length > 0) {
        writer.writePackedBool(13, f);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedBytes(15, f);
    }
};
/**
...
proto.examplecom.RepeatedPrimitiveMessage.prototype.getMyBytesList_asB64 = function () {
    return /** @type {!Array.<string>} */ (jspb.Message.bytesListAsB64(this.getMyBytesList()));
};
/**
 * repeated bytes my_bytes = 15;
...
proto.examplecom.RepeatedPrimitiveMessage.prototype.getMyBytesList_asU8 = function () {
    return /** @type {!Array.<!Uint8Array>} */ (jspb.Message.bytesListAsU8(this.getMyBytesList()));
};
...
//# sourceMappingURL=repeated_primitive_message_pb.js.map